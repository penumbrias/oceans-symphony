...
export const HOME_STYLES = [
  ...
  },
  {
    ...
    shell: "",
    look: { radius: 16, outlineW: 1, borderColor: "#8a8a9a55", bg: "#20202b", bgOpacity: 45, padding: 8, blur: 6 },
  },
  {
    id: "social",
    label: "Social feed",
    ...
    shell: "",
    look: { radius: 12, outlineW: 1, borderColor: "#8a8a9a33", bg: "#1a1a24", padding: 10, shadow: "soft" },
  },
  {
    id: "toybox",
    label: "Toybox",
    ...
    shell: "",
    look: { radius: 12, outlineW: 3, borderColor: "#e8e8f0cc", bg: "#1a1a24", padding: 8, shadow: "hard" },
  },
  {
    id: "forum",
    label: "Old forum",
    ...
    shell: "",
    look: { radius: 0, outlineW: 2, borderColor: "#8a6a3a66", borderStyle: "double", bg: "#2a2318", padding: 8, font: "serif" },
  },
  {
    id: "terminal",
    label: "Terminal",
    ...
    shell: "",
    look: { radius: 0, outlineW: 1, borderColor: "#3fbf3f66", bg: "#050805", padding: 8, font: "monospace", accent: "#3fbf3f", shadow: "glow" },
  },
  {
    id: "spreadsheet",
    label: "Spreadsheet",
    ...
    shell: "",
    look: { radius: 0, outlineW: 1, borderColor: "#3f7f5f66", bg: "#101418", padding: 6 },
  },
  {
    id: "aero",
    label: "Aero",
    ...
    shell: "",
    look: { radius: 16, outlineW: 1, borderColor: "#ffffff40", padding: 8,
  ...
  },
  {
    ...
    shell: "",
    look: { radius: 0, outlineW: 0, padding: 0 },
  },
];
