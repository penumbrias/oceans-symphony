...
export const CHANGELOG = [
  {
    ...
    changes: [
      ...
      {
        type: "improve",
        text: "Preview Mode is now a single, much more fleshed-out example: The Tapestry, a polyfragmented DID system with 24 alters across hosts, protectors, caretakers, littles, teens, introjects, gatekeeper, persecutors, fragments, and dormants — plus splits, a fusion, a dormancy, busy switching, status notes, and rich relationships. Several alters carry their own theme preset that takes over the whole app (colors, font, AND vocabulary) when they're the primary fronter — Iris, Vex, and Halo each bring a different look. Profile pages range from plain prose to fully-styled cards: Atlas's constellation, Iris's newspaper column, Halo's tarot card, Vex's stark dark page, Poppy's sticker-coded kid page, Gate's monospace clinical card. The two earlier examples (The Hearth, Inner Compass) have been retired in favour of one richer demo.",
      },
      {
        type: "improve",
