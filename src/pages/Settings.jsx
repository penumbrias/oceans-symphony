      ...
      {/* Privacy & Security Notice */}
        <Card className="border-amber-500/30 bg-amber-500/5">
          ...
          <CardContent className="space-y-3 text-sm text-muted-foreground">
            ...
            <p><strong className="text-foreground">Unencrypted and Nonlocal data is currently stored without end-to-end encryption. Meaning I, as developer, technically could access it. I am commited to never doing so.</strong> Please be mindful of what you enter if this concerns you, or simply use local storage mode which completely negates this.</p>
