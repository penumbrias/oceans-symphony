      ...
      {/* Privacy & Security Notice */}
        <Card className="border-amber-500/30 bg-amber-500/5">
          ...
          <CardContent className="space-y-3 text-sm text-muted-foreground">
            ...
            <p>As the developer, I technically have access to data through the Base44 dashboard. I am committed to never accessing, reading, or using your personal data. However, I want to be transparent that this technical access exists.</p>
            <p><strong className="text-foreground">Custom fields</strong> (trauma triggers, fears, beliefs, etc.) and other personal entries are currently stored without end-to-end encryption. Please be mindful of what you enter if this concerns you.</p>
            ...
            <p>This app is free, open, and shared in good faith with the plural community. If you have concerns, please reach out.</p>
          </CardContent>
        </Card>
        {/* System Name */}
