...
export default {
  ...
  "nav.showAlterBar": "Show pinned {{alters}}",
  "nav.hideAlterBar": "Hide pinned {{alters}}",
  ...
  "widget.today.addTitle": "Add to today",
  "widget.today.addNew": "New",
  "widget.today.addFromList": "From my list",
  "widget.today.addBtn": "Add",
  "widget.today.tapToAdd": "tap to add something",
  "widget.today.searchTasks": "Search tasks…",
  "widget.today.noTasks": "Nothing waiting in your list.",
  ...
  "planner.closeAskTitle": "You changed this plan",
  "planner.closeAskBody": "Edits here apply as you make them. Keep what you changed, or undo it all back to how the plan was when you opened it?",
  "planner.keepChanges": "Keep changes",
  "planner.undoChanges": "Undo my changes",
  "planner.keepEditing": "Keep editing",
  "planner.editUndone": "Changes undone",
  "planner.massCancel": "Cancel plans",
  "planner.exitSelect": "Done selecting",
  "planner.massDeleteConfirm": "Delete {count} plan(s)? This cannot be undone.",
  "planner.massCancelConfirm": "Mark {count} plan(s) as cancelled?",
  "planner.massDeleted": "{count} plan(s) deleted",
  "planner.massCancelled": "{count} plan(s) cancelled",
  ...
  "planner.biweekly": "Every 2 weeks",
  "planner.monthly": "Monthly",
  "planner.everyNDays": "Every {n} days",
  "planner.allPlans": "All",
  "planner.uncategorized": "Uncategorized",
  "planner.noCategory": "no category",
  "planner.noPlans": "Nothing scheduled.",
  "planner.editNext": "Next occurrence",
  "planner.editFuture": "This + future ({count})",
  "planner.seriesFuture": "Editing this + future ({count})",
  "editSheet.actionsAttach": "Quick actions row",
  "editSheet.attachFloat": "Floating card",
  "editSheet.attachBar": "Inside the bar",
  "editSheet.barsSwap": "Swap with bottom bar",
  "editSheet.barsSwapNormal": "Tabs stay, actions fold away",
  "editSheet.barsSwapSwapped": "Actions stay, tabs fold away",
  "editSheet.altersAttach": "Bar placement",
  "editSheet.barColors": "Colours",
  "editSheet.gradient": "Gradient",
  "editSheet.gradAngle": "Gradient angle",
  "editSheet.shadow": "Shadow",
  ...
  "planner.stillFronting": "still here",
  "planner.openProfile": "Profile",
  "planner.frontHistory": "{Front} history",
  "planner.done": "Done",
  ...
  "planner.what": "What",
  "planner.whatChange": "Change",
  "planner.whatDone": "Done",
  "planner.whatNone": "No activity linked",
  "planner.startNow": "Start now",
  "planner.inProgress": "In progress",
  "planner.pause": "Pause",
  "widget.today.anytime": "Any time",
  "planner.anytime": "any time",
  "planner.anytimeToday": "Today · any time",
  "planner.resolvedTab": "Resolved",
  "planner.linkedTodo": "Linked to-do",
  "planner.todoLabel": "To-do",
  "planner.linkTodo": "Link a to-do",
  "planner.todoMatchHint": "Matching to-dos:",
  "planner.unlinkTodo": "Unlink",
  "planner.scheduled": "Scheduled",
  "planner.whenLabel": "When",
  "planner.durLabel": "Length",
  "planner.whatLabel": "What",
  "planner.noTimeSet": "No day or time set",
  "planner.startedToast": "Started — it's now in your Active Activities",
  "planner.close": "Close",
  "planner.modeDuration": "Start + length",
  "planner.modeRange": "Start \u2192 end",
  "planner.startsAt": "Starts",
  "planner.endsAt": "Ends",
  "planner.endDate": "End date",
  "planner.endTime": "End time",
  "planner.nextDay": "ends the next day",
  "planner.when": "When",
  "planner.details": "Details",
  "planner.matchHint": "Link to:",
  "planner.noCategory": "No category",
  ...
  "notices.startPlan": "Start",
  "notices.startedAt": "Started at",
  "notices.startGo": "Go",
  "notices.planDetails": "Details\u2026",
  ...
  "editSheet.handleSides": "Handle halves",
  "editSheet.actionsEdge": "Edge",
  "editSheet.edgeBottom": "Bottom bar",
  "editSheet.edgeTop": "Top bar",
  "editSheet.handleAltersLeft": "Pinned {alters} left · quick actions right",
  "editSheet.handleAltersRight": "Quick actions left · pinned {alters} right",
  ...
  "editSheet.topItem.active": "Active now (when something is)",
  "editSheet.activeBubble": "Active-now bubble",
  "editSheet.activeOff": "Off",
  "editSheet.activeWhen": "When something is active",
  "editSheet.activeAlways": "Always",
  "capture.active": "Active",
  "active.title": "Active now",
  "active.none": "Nothing running right now.",
  ...
  "editSheet.colorsHint": "Every visible color. Opacity lives inside each color's picker. Highlight is the new UI's own accent (page dots, active tab, focus rings) — it follows Primary until you set it.",
  "editSheet.colorHighlight": "Highlight",
  "editSheet.followPrimary": "Follow Primary again",
  "editSheet.followsPrimary": "Following Primary",
  ...
  "editSheet.tabStyle": "Style",
  "editSheet.tabLayout": "Layout & size",
  "editSheet.presetSearch": "Search presets…",
  ...
  "editSheet.themeRestylesWidgets": "Applying a theme also restyles the widgets to match",
  "editSheet.customiseWidgetLook": "Customise a widget look (use one as a base)…",
  "editSheet.presetsBuiltIn": "Built-in",
  "editSheet.presetApply": "Apply",
  "editSheet.presetLink": "Link to an {alter}",
  "editSheet.undoHistory": "Undo — recent looks",
  "editSheet.beforeLabel": "Before {name}",
