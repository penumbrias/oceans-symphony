...
export default {
  ...
  "widget.guide.title": "Welcome to your home screen",
  "widget.guide.line1": "Everything here is a widget — hold one and drag to move it; hold and let go to select several.",
  "widget.guide.line2": "Use Start editing to add, resize, restyle or delete widgets — including this guide.",
  "widget.guide.line3": "This page mirrors the classic dashboard as a starting point. Change anything, or build your own on the next page.",
  "widget.guide.browseStyles": "Browse styles",
  "widget.guide.samplePacks": "Layout packs",
  "widget.guide.startEditing": "Start editing",
  "widget.guide.footer": "Delete this guide any time in editing — it's just a widget.",
