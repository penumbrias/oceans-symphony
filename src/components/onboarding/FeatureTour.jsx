...
function buildSteps(t, alterId = null, tourAlterWasCreated = false) {
  ...
  return [
    ...
    // ─── SETTINGS ───────────────────────────────────────────────────────────
    {
      ...
      body: `Settings has 8 collapsible sections. The highlighted quick-nav button row at the top jumps to any section without scrolling. Each section header expands when tapped. Sections: ${t.System}, Appearance, Accessibility, ${t.Alters} & Fields, Check-In & Tracking, Analytics, Reminders, and Data & Privacy.`,
