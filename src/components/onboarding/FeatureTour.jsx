...
function buildSteps(t) {
  return [
    ...
    },
    {
      ...
      look: `the 👁 + ⚙️ icon row highlighted above — it appears in the Groups header or on the ${t.Alters} section divider`, action: null,
    },
    {
      section: "alters", sectionLabel: t.Alters,
      emoji: "➕",
      title: `Adding a New ${t.Alter}`,
      body: `Tap the + Add ${t.Alter} button in the top-right corner to create a new profile. Set their name, pronouns, role, color, avatar, bio, and any custom fields configured in Settings → ${t.Alters} & Fields. You can also connect a Simply Plural ${t.alter} profile.`,
      route: "/Home", target: "alter-add-btn",
      look: `the highlighted "+ Add ${t.Alter}" button in the top-right corner`, action: null,
    },
    {
      section: "alters", sectionLabel: t.Alters,
      emoji: "📋",
      ...
      route: "/Home", target: "alters-grid",
      look: `tap any ${t.alter} card in the list, then look at the tabs across the top of their profile`, action: null,
    },
    {
      section: "alters", sectionLabel: t.Alters,
      emoji: "✉️",
      ...
      route: "/Home", target: "alters-grid",
      look: `tap any ${t.alter} card, switch to the "Messages" tab, and use the compose button`, action: null,
    },
