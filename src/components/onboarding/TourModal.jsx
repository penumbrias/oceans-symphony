...
const STEPS = (t) => [
  ...
  {
    title: `Your ${t.Alters}`,
    subtitle: 'Every part of the system, all in one place',
  ...
  },
  {
    ...
    body: `Log who is fronting with a single tap. Track primary fronters and co-fronters. All fronting history feeds into your timeline and analytics automatically.`,
    icon: <Heart className='w-8 h-8' />,
    color: 'from-rose-500/20 to-orange-500/20',
    tip: 'Tap to add as co-fronter, long press to set as primary',
    features: ['Primary and co-fronter tracking', 'Session history on timeline', 'Analytics and patterns', 'Switch logging'],
  },
  {
    title: 'System Map',
    subtitle: 'Visualize your inner world',
    body: `Map out relationships between alters, build your inner world with locations, and explore how your system connects. The analytics map shows fronting patterns and overlap.`,
    icon: <Map className='w-8 h-8' />,
    color: 'from-blue-500/20 to-cyan-500/20',
    tip: 'Double-tap an alter on the inner world map to enter relationship mode',
  ...
  },
  {
    ...
    subtitle: 'Track how the system is doing day to day',
    body: `Quick check-ins let any part log emotions, symptoms, activities, diary entries, and notes in one place. Everything is timestamped and tied to who was fronting.`,
  ...
  {
    title: 'Journals',
    subtitle: 'Write, remember, and share across the system',
    body: `Journal entries can be written by specific alters and shared with the system. Mention other alters with @ to send them notifications. The bulletin board is for system-wide messages.`,
    icon: <BookOpen className='w-8 h-8' />,
    color: 'from-green-500/20 to-teal-500/20',
    tip: 'Use @ mentions in journals and bulletins to notify specific alters',
    features: ['Private and shared entries', '@ mentions with notifications', 'Bulletin board', 'Threaded comments', 'Rich text blocks'],
  },
  {
    title: 'Timeline',
    subtitle: 'Your system\'s history, all in one view',
    body: `The infinite timeline shows everything — fronting sessions, emotions, activities, symptoms, journal entries, and tasks — laid out chronologically by day. Zoom in and out to explore.`,
    icon: <Clock className='w-8 h-8' />,
    color: 'from-indigo-500/20 to-blue-500/20',
    tip: 'Double-tap a fronting bar on the timeline to edit that session\'s start and end time',
    features: ['Fronting session bars', 'Emotion and symptom events', 'Activity tracking', 'Zoom and scroll', 'Daily tally view'],
  },
  {
    title: 'Analytics',
    subtitle: 'Understand your system\'s patterns',
    body: `See which alters front most, when switching happens, emotion patterns, symptom trends, and more. Analytics draw from all your logged data automatically.`,
    icon: <BarChart2 className='w-8 h-8' />,
    color: 'from-violet-500/20 to-indigo-500/20',
    tip: 'The more you log, the more meaningful your analytics become',
    features: ['Fronting distribution', 'Co-fronting patterns', 'Emotion trends', 'Symptom analytics', 'Activity summaries'],
  },
  {
    title: 'Support & Learn',
  ...
  },
  {
    ...
    body: `Oceans Symphony supports local-only mode with AES-256 encryption — your data never leaves your device. Regular backups are recommended. The app is free and open source, built by a DID system.`,
    icon: '🔒',
  ...
  },
  {
    ...
    body: `Explore at your own pace. Every feature is designed with dissociative systems in mind. You can reopen this guide anytime from the Guide button on the home screen.`,
    icon: '💜',
    color: 'from-violet-500/20 to-purple-500/20',
    tip: null,
    features: null,
