...
const ENTITY_NAMES = [
  ...
  "Contact", "ContactNote", "ContactRelationship", "ContactCustomField",
];
...
const EXPORT_CATEGORIES = [
  ...
  { id: "contacts",      label: "Contacts",                 entities: ["Contact", "ContactNote", "ContactRelationship", "ContactCustomField"],   desc: "External people: contact info, safety, boundaries, system rules, their notes, relationships & custom fields" },
];
