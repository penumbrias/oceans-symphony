...
import { HardDrive, Cloud, Lock, Loader2, ShieldCheck, ShieldOff, Eye, AlertCircle, Trash2 } from "lucide-react";
import {
...
import { enableEncryption, disableEncryption, initLocalDb, loadDbDump } from "@/lib/localDb";
...
export default function StorageModeSettings() {
  ...
  const confirmSwitch = () => setSwitchConfirmOpen(true);
            ...
            <>
                  ...
                  {!encEnabled ? (
                    ...
                    <>
                      ...
                      <Button variant="outline" onClick={() => { setShowPasswordForm("disable"); setError(""); setSuccess(""); }} className="gap-2 text-destructive hover:text-destructive">
                        <ShieldCheck className="w-4 h-4" /> Remove
                      </Button>
                    </>
                  )}
                </div>
              ...
              {!showDeleteConfirm && (
                <Button
                  ...
                  className="w-full gap-2 text-destructive hover:text-destructive hover:bg-destructive/10 text-sm"
                >
                ...
                <div className="rounded-xl border border-destructive/40 bg-destructive/5 p-4 space-y-3">
                  ...
                  <div className="flex gap-2">
                    ...
                    <Button
                      ...
                      disabled={deleteInput.trim().toLowerCase() !== "delete my data" || deleting}
      ...
      <Dialog open={switchConfirmOpen} onOpenChange={setSwitchConfirmOpen}>
        <DialogContent>
          ...
          <DialogDescription className="space-y-2">
            ...
            <p className="font-bold">Local stores all data offline on your device itself rather than uploading data to a server. ⚠️ Please backup your data before switching — use "Backup & Export" below to save a full copy.</p>
