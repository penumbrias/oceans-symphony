...
import {
  getMode, setMode,
  isEncryptionEnabled, setEncryptionEnabled } from
"@/lib/storageMode";
...
export default function StorageModeSettings() {
  ...
  const handleDisableEncryption = async () => {
    ...
    try {
      ...
      setShowPasswordForm(null);
      setOldPassword("");
    } catch {setError("Incorrect password.");} finally
    {setLoading(false);}
  };
  ...
  const handleChangePassword = async () => {
    ...
    } catch {setError("Incorrect current password.");} finally
    {setLoading(false);}
  };
...
**Because this is still just a webapp, CLEARING YOUR BROWSER HISTORY WILL CLEAR YOUR LOCAL DATA!! until the app is installable, make FREQUENT backups of your data if you store locally!!
            </p>
