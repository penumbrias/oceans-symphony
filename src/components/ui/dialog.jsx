...
const DialogContent = React.forwardRef(({ className, children, onInteractOutside, style, showCloseButton = true, ...props }, ref) => {
  ...
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ...
      className={cn(
        // overflow-y-auto is load-bearing: maxHeight above clamps every
        // dialog to the viewport, and WITHOUT a scroll the overflow just
        // clips — on landscape phones that meant cut-off, unreachable
        // controls in any dialog taller than ~340px. Dialogs that manage
        // their own internal scrolling override this via className.
