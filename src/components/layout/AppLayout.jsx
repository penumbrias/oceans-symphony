...
import { Users, Sparkles, BookOpen, CheckSquare, Home, Settings, ChevronLeft } from "lucide-react";
          ...
          <nav className="flex items-center gap-1" aria-label="Main navigation">
            {navItems.map((item) => {
              ...
              const isActive =
                ...
                item.path === "/Home" ? location.pathname === "/Home" || location.pathname.startsWith("/alter") :
              ...
              return (
                <Link
                  ...
                  className="text-muted-foreground px-2 text-sm font-medium rounded-lg flex items-center gap-2 transition-all duration-200 select-none min-h-[44px] hover:text-foreground hover:bg-muted/50"
                >
            ...
            <Link
              ...
              className="text-muted-foreground px-3 text-sm font-medium rounded-lg flex items-center gap-2 transition-all duration-200 select-none min-h-[44px] hover:text-foreground hover:bg-muted/50"
            >
