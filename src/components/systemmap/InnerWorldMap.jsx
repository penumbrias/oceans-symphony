...
export default function InnerWorldMap({ alters: allAlters, relationships, onRefreshRelationships }) {
  ...
  return (
    <div className="relative w-full h-full flex" style={{ touchAction: 'none' }}>
      ...
      <div className="relative flex-1 min-w-0 h-full bg-card overflow-hidden"
        ...
        <svg
          ...
          style={{ cursor: isDragging ? "grabbing" : relModeAlter ? "crosshair" : placingAlter ? "crosshair" : "grab", touchAction: 'none' }}
