...
// Replace handleSetPrimary — with individual sessions "primary" is just a display concept
// For now we can keep the legacy behavior for the primary indicator:
...
// Update isFronting to work with both formats:
const isFronting = currentSession && (
